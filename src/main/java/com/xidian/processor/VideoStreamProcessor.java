...
public class VideoStreamProcessor {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //Read properties
        Properties prop = PropertyFileReader2.readPropertyFile();
        ...
        //process
        Dataset<VideoEventData> processedDataset = kvDataset.mapGroupsWithState(new MapGroupsWithStateFunction<String,
                VideoEventData, VideoEventData,VideoEventData>(){
            @Override
            public VideoEventData call(String key, Iterator<VideoEventData> values, GroupState<VideoEventData> state)
                    throws Exception {
